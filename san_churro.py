...
status_logs = json.loads(supabase.table("StoreStatusLogs").select("*").eq("brand", "sanchurro").execute().json())["data"]

store_data = requests.get("https://sanchurro.redcatcloud.com.au/api/v1/stores").json()["data"]
