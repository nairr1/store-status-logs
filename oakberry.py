...
status_logs = json.loads(supabase.table("StoreStatusLogs").select("*").eq("brand", "oakberry").execute().json())["data"]

store_data = requests.get("https://oakberry.redcatcloud.com.au/api/v1/stores").json()["data"]
