...
status_logs = json.loads(supabase.table("StoreStatusLogs").select("*").eq("brand", "augustusgelatery").execute().json())["data"]

store_data = requests.get("https://augustusgelatery.redcatcloud.com.au/api/v1/stores").json()["data"]
