...
status_logs = json.loads(supabase.table("StoreStatusLogs").select("*").eq("brand", "burgerurge").execute().json())["data"]

store_data = requests.get("https://burgerurge.redcatcloud.com.au/api/v1/stores").json()["data"]
