...
status_logs = json.loads(supabase.table("StoreStatusLogs").select("*").eq("brand", "banjos").execute().json())["data"]

store_data = requests.get("https://banjos.redcatcloud.com.au/api/v1/stores").json()["data"]
