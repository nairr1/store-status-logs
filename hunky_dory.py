...
status_logs = json.loads(supabase.table("StoreStatusLogs").select("*").eq("brand", "hunkydory").execute().json())["data"]

store_data = requests.get("https://hunkydory.redcatcloud.com.au/api/v1/stores").json()["data"]
