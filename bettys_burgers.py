...
status_logs = json.loads(supabase.table("StoreStatusLogs").select("*").eq("brand", "bettysburgers").execute().json())["data"]

store_data = requests.get("https://bettysburgers.redcatcloud.com.au/api/v1/stores").json()["data"]
