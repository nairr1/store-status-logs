...
status_logs = json.loads(supabase.table("StoreStatusLogs").select("*").eq("brand", "boostjuice").execute().json())["data"]

store_data = requests.get("https://boostjuice.redcatcloud.com.au/api/v1/stores").json()["data"]
