...
status_logs = json.loads(supabase.table("StoreStatusLogs").select("*").eq("brand", "salsas").execute().json())["data"]

store_data = requests.get("https://salsas.redcatcloud.com.au/api/v1/stores").json()["data"]
