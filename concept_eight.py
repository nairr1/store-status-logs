...
status_logs = json.loads(supabase.table("StoreStatusLogs").select("*").eq("brand", "concept8rewards").execute().json())["data"]

store_data = requests.get("https://concept8rewards.redcatcloud.com.au/api/v1/stores").json()["data"]
