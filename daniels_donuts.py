...
status_logs = json.loads(supabase.table("StoreStatusLogs").select("*").eq("brand", "danielsdonuts").execute().json())["data"]

store_data = requests.get("https://danielsdonuts.redcatcloud.com.au/api/v1/stores").json()["data"]
