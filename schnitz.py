...
status_logs = json.loads(supabase.table("StoreStatusLogs").select("*").eq("brand", "schnitz").execute().json())["data"]

store_data = requests.get("https://schnitz.redcatcloud.com.au/api/v1/stores").json()["data"]
