...
status_logs = json.loads(supabase.table("StoreStatusLogs").select("*").eq("brand", "lonestar").execute().json())["data"]

store_data = requests.get("https://lonestar.redcatcloud.com.au/api/v1/stores").json()["data"]
