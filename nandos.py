...
status_logs = json.loads(supabase.table("StoreStatusLogs").select("*").eq("brand", "nandos").execute().json())["data"]

store_data = requests.get("https://nandos.redcatcloud.com.au/api/v1/stores").json()["data"]
