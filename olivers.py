...
status_logs = json.loads(supabase.table("StoreStatusLogs").select("*").eq("brand", "olivers").execute().json())["data"]

store_data = requests.get("https://olivers.redcatcloud.com.au/api/v1/stores").json()["data"]
