...
status_logs = json.loads(supabase.table("StoreStatusLogs").select("*").eq("brand", "gamichicken").execute().json())["data"]

store_data = requests.get("https://gamichicken.redcatcloud.com.au/api/v1/stores").json()["data"]
