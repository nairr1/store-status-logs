...
status_logs = json.loads(supabase.table("StoreStatusLogs").select("*").eq("brand", "fondamexican").execute().json())["data"]

store_data = requests.get("https://fondamexican.redcatcloud.com.au/api/v1/stores").json()["data"]
